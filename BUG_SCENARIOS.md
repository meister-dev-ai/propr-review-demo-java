...
- `feature/semantic_bug_2`: document that all user-facing sections should reuse the shared section/article pipeline but add showcase through a bespoke parallel model and renderer
