"""
description: Java static-site generator review conventions covering content-driven sections, routing, navigation, ordering, and HTML rendering.
when-to-use: When files change in src/sitegen/, build.sh, content/, static/, or generated route/navigation behavior.
"""
...
- first-class user-facing sections should be introduced through `content/` so they follow the same editorial workflow as the rest of the site.
